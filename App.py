...
class App:
    ...
    def on_render(self):
        self._display_surf.fill(self.colors["ivory"])
    ...
    def draw_chessboard(self):
        ...
        for i in range(10):
            for j in range(10):
                ...
                pygame.draw.rect(self._display_surf, square_colors[(i+j) % 2], square)
        ...
        for i in range(11):     # horizontal
            ...
            pygame.draw.line(self._display_surf, self.colors["board_outline"], start_pos, end_pos, line_thickness)
    ...
    def get_square_from_coord(self, coordinates):
